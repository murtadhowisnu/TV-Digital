...
<tr>
    ...
    <th width="25%" colspan="2" style="border: 1px solid black;background-color:#FCF305;color:red;text-align:center;"><?=$ket_a['tgl_spt']; ?></th>
    <th width="10%" style="border: 1px solid black;text-align: center;"></th>
</tr>
<tr>
...
<tr>
    ...
    <th width="25%" colspan="2" style="border: 1px solid black;background-color:#FCF305;color:red;text-align:center;"><?=$ket_a['ket_lat']; ?></th>
    <th width="10%" style="border: 1px solid black;text-align: center;"></th>
</tr>
<tr>
    <th style="border: 1px solid black;">Longitude</th>
    <th width="25%" colspan="2" style="border: 1px solid black;background-color:#FCF305;color:red;text-align:center;"><?=$ket_a['ket_lng']; ?></th>
    <th width="10%" style="border: 1px solid black;text-align: center;"></th>
</tr>