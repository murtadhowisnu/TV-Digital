...
<tr>
<td colspan="2">UPT</td>
<td style="text-align: left;background-color:#FCF305;color:green;"><?= $masuk['upt']; ?></td>
<td></td>
<td></td>
<td colspan="2"></td>
</tr>
...
<thead style="background-color: #C0C0C0;">
            ...
            <tr>
                ...
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;" colspan="2"><?= $stasiun['penyelenggara'];?></td>
                <td style="border: 1px solid black;text-align: center;">-</td>    
            </tr>
            <tr>
                <td style="border: 1px solid black;" colspan="3">b. Alamat</td>
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;" colspan="2"><?= $stasiun['alamat'];?></td>
                <td style="border: 1px solid black;text-align: center;">-</td>    
            </tr>
            <tr>
                <td style="border: 1px solid black;" colspan="3">c. Kelurahan</td>
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;" colspan="2"><?= $stasiun['kelurahan'];?></td>
                <td style="border: 1px solid black;text-align: center;">-</td>    
            </tr>
            <tr>
                <td style="border: 1px solid black;" colspan="3">d. Kecamatan</td>
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;" colspan="2"><?= $stasiun['kecamatan'];?></td>
                <td style="border: 1px solid black;text-align: center;">-</td>    
            </tr>
            <tr>
                <td style="border: 1px solid black;" colspan="3">e. Kota Madya</td>
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;" colspan="2"><?= $stasiun['kotamadya'];?></td>
                <td style="border: 1px solid black;text-align: center;">-</td>    
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;" colspan="2"><?= $stasiun['email'];?></td>
                <td style="border: 1px solid black;text-align: center;">-</td>    
            </tr>
            </tbody> 
