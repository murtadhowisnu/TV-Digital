...
<div id="invoice">
    ...
    <table border="1" cellpadding="5" width="80%" style="font-size:10px;text-align:center; margin-left:auto;margin-right:auto;margin-top:50px;">
        ...
        <tr>
            <td>
                <img src="<?=base_url('assets/SCAN/') . $scan_bw['file']?>" alt="" height="240px" width="300px">
            </td>
            <td><?=$hasil['freq_terukur']; ?></td>
    ...
    <table border="1" cellpadding="5" width="80%" style="font-size:10px;text-align:center; margin-left:auto;margin-right:auto;margin-top:140px;">
        ...
        <tr>
            <td>
                <img src="<?=base_url('assets/SCAN/') . $scan_geser['file']?>" alt="" height="240px" width="300px">
            </td>
            <td><?=$hasil['freq_terukur']; ?></td>
    ...
    <table border="1" cellpadding="5" width="80%" style="font-size:10px;text-align:center; margin-left:auto;margin-right:auto;margin-top:10px;">
        ...
        <tr>
            <td>
                <img src="<?=base_url('assets/SCAN/') . $scan_dev['file']?>" alt="" height="240px" width="300px">
            </td>
            <td><?=$hasil['freq_terukur']; ?></td>
            <td><?=$hasil['deviasi']; ?></td>
            <td></td>
    ...
    <table border="1" cellpadding="5" width="80%" style="font-size:10px;text-align:center; margin-left:auto;margin-right:auto;margin-top:10px;">
        ...
        <tr>
            <td>
                <img src="<?=base_url('assets/SCAN/') . $scan_fs['file']?>" alt="" height="240px" width="300px">
            </td>
            <td><?=$hasil['freq_terukur']; ?></td>
    ...
    <table border="1" cellpadding="5" width="80%" style="font-size:10px;text-align:center; margin-left:auto;margin-right:auto;margin-top:30px;">
        <tr>
        ...
        <tr>
            <td>
                <img src="<?=base_url('assets/SCAN/') . $scan_h1['file']?>" alt="" height="240px" width="300px">
            </td>
    ...
    <table border="1" cellpadding="5" width="80%" style="font-size:10px;text-align:center; margin-left:auto;margin-right:auto;margin-top:10px;">
        ...
        <tr>
            <td>
                <img src="<?=base_url('assets/SCAN/') . $scan_h2['file']?>" alt="" height="240px" width="300px">
            </td>
    ...
    <table border="1" cellpadding="5" width="80%" style="font-size:10px;text-align:center; margin-left:auto;margin-right:auto;margin-top:10px;">
        ...
        <tr>
            <td>
                <img src="<?=base_url('assets/SCAN/') . $scan_h3['file']?>" alt="" height="240px" width="300px">
            </td>
 ...
 <div class="modal fade" id="editfotoModal" tabindex="-1" aria-labelledby="editfotoModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/editfoto'); ?>" method="POST" enctype="multipart/form-data">
