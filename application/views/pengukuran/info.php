    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                <a href="#" onclick="goBack()" class="btn mb-3 ml-3" style="background-color: #007DFF; color:white;">
                ...
                <a target="_blank" href="<?= base_url('pengukuran/download/' . str_replace('/', '-', $detail['no_spt'])); ?>">
                    <button class="btn btn-lg btn-danger clearfix mb-3 ml-3"><span class="fas fa-file-pdf"></span> Download as PDF</button>
                </a>
                <a target="_blank" href="<?= base_url('pengukuran/export/' . str_replace('/', '-', $detail['no_spt'])); ?>">
                ...
                <a target="_blank" href="<?= base_url('pengukuran/scan/' . str_replace('/', '-', $detail['no_spt'])); ?>">
