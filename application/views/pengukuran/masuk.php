    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                <a href="<?= base_url('pengukuran/info') ?>" class="btn mb-3 ml-3" style="background-color: #007DFF; color:white;">
                ...
                <a target="_blank" href="<?= base_url('pengukuran/download/' . $bw['session']); ?>">
                    <button class="btn btn-lg btn-danger clearfix mb-3 ml-3"><span class="fas fa-file-pdf"></span> Download as PDF</button>
                </a>
                <a target="_blank" href="<?= base_url('pengukuran/export/' . $bw['session']); ?>">
                ...
                <a target="_blank" href="<?= base_url('pengukuran/scan/' . $bw['session']); ?>">
