...
<tbody>
    ...
    <tr>
        ...
        <td colspan="2" style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;"><?= $detail['tinggi_lok']; ?></td>
        <td style="border: 1px solid black;text-align: center;">-</td>
    </tr>
    <tr>
        <td style="border: 1px solid black;" colspan="3">h. Tinggi Gedung</td>
        <td colspan="2" style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;"><?= $detail['tinggi_ged']; ?></td>
        <td style="border: 1px solid black;text-align: center;">-</td>
    </tr>
    <tr>
        <td style="border: 1px solid black;" colspan="3">i. Tinggi Menara</td>
        <td colspan="2" style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;"><?= $detail['tinggi_men']; ?></td>
        <td style="border: 1px solid black;text-align: center;">-</td>
    </tr>
</tbody>