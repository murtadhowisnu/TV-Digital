        <tbody>
            <tr>
                ...
                <td rowspan="10" width="10%" style="text-align: center;border: 1px solid black;">Antena</td>
                ...
                <th style="background-color:white" width="10%"><a href="#" data-toggle="modal" data-target="#editModal5">Edit</a></th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;"><?= $detail['elemen'] ?></td>
                <td style="border: 1px solid black;text-align: center;  " width="10%">Bay</td>
                <td style="border: 1px solid black;text-align: center;">-</td>
            </tr>
            <tr>
                <td style="border: 1px solid black;" colspan="2">d. Gain</td>
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;"><?= $detail['gain'] ?></td>
            ...
            <tr>
                ...
                <td colspan="2" style="border: 1px solid black;text-align: center; background-color:#FCF305;color:green;"><?= $detail['beam'] ?></td>
                <td style="border: 1px solid black;text-align: center;">-</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;"><?= $detail['panjang_kabel'] ?></td>
