            ...
            <tr>
                ...
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;"><?= str_replace('.', ',', $detail['h1_freq']); ?></td>
            ...
            <tr>
                ...
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;"><?= str_replace('.', ',', $detail['h1_level']); ?></td>
            ...
            <tr>
                ...
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;"><?= str_replace('.', ',', $detail['h2_freq']); ?> </td>
                <td style="border: 1px solid black;text-align: center;">MHz</td>
                <td rowspan="2" style="border: 1px solid black;text-align: center;vertical-align:middle">
                    <?php
            ...
            <tr>
                ...
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;"><?= str_replace('.', ',', $detail['h2_level']); ?></td>
                <td style="border: 1px solid black;text-align: center;">dB</td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                ...
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;"><?= str_replace('.', ',', $detail['h3_freq']); ?></td>
                <td style="border: 1px solid black;text-align: center;">MHz</td>
                <td rowspan="2" style="border: 1px solid black;text-align: center;vertical-align:middle">
                    <?php
            ...
            <tr>
                ...
                <td style="border: 1px solid black;text-align: center;  background-color:#FCF305;color:green;"><?= str_replace('.', ',', $detail['h3_level']); ?></td>
                <td style="border: 1px solid black;text-align: center;">dB</td>
            </tr>
            </tbody>