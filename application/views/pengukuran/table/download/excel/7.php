...
<tr>
    ...
    <th width="25%" colspan="2" style="border: 1px solid black;background-color:#FCF305;color:red;text-align:center;"><?= str_replace('.', ',', $detail['lat_ket']); ?></th>
    <th width="10%" style="border: 1px solid black;text-align: center;"></th>
</tr>
<tr>
    <th></th>
    <th style="border: 1px solid black;">Longitude</th>
    <th width="25%" colspan="2" style="border: 1px solid black;background-color:#FCF305;color:red;text-align:center;"><?= str_replace('.', ',', $detail['lng_ket']); ?></th>
    <th width="10%" style="border: 1px solid black;text-align: center;"></th>
</tr>